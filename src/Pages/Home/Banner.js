...
const Banner = () => {
  return (
    <div class="hero min-h-screen px-20 bg-[#01073a]">
      <div class="hero-content flex-col lg:flex-row-reverse">
        ...
        <div>
          <img
            className="w-20 my-4 lg:hover:translate-x-96 hover:translate-x-40 transition ease-in-out delay-250 duration-300"
            src={rocket}
            alt=""
          />
